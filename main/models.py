...
class ProductTagsManager(models.Manager):
...
class Address(models.Model):
    ...
    zip_code = models.CharField("ZIP / Postal code", max_length=12, blank=True)
...
class Order(models.Model):
    ...
    PAID = 20
    DONE = 30
    STATUS = ((NEW, 'New'), (PAID, "Paid"), (DONE, "Done"))
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    status = models.IntegerField(choices=STATUS, default=NEW)
    billing_name = models.CharField(max_length=60)
    billing_address1 = models.CharField(max_length=128)
    billing_address2 = models.CharField(max_length=128, blank=True)
    billing_zip_code = models.CharField(max_length=12)
    billing_city = models.CharField(max_length=60)
    billing_country = models.CharField(max_length=3)
    shipping_name = models.CharField(max_length=60)
    shipping_address1 = models.CharField(max_length=128)
    shipping_address2 = models.CharField(max_length=128, blank=True)
