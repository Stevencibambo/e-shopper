    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address2', models.CharField(blank=True, max_length=128)),
                ...
                ('shipping_address2', models.CharField(blank=True, max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('active', models.BooleanField(default=True)),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.producttag')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('uk', 'United Kingdom'), ('us', 'United Stated of America')], max_length=3)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
